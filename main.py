...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.use_webcam_button.setStyleSheet("background-color: #ff0000; color: black; font-weight: bold;")

        self.scan_new_files_button.setFixedSize(150, 50)
        self.scan_new_files_button.clicked.connect(self.start_scanning_new_files)
        self.scan_new_files_button.setStyleSheet("background-color: #ffff00; color: black; font-weight: bold;")

        self.scan_all_files_button.setFixedSize(150, 50)
        self.scan_all_files_button.clicked.connect(self.start_scanning_all_files)
        self.scan_all_files_button.setStyleSheet("background-color: #00ff00; color: black; font-weight: bold;")
        ...
        buttons_vbox.addWidget(self.use_webcam_button, alignment=Qt.AlignmentFlag.AlignCenter)
        buttons_vbox.addWidget(self.scan_new_files_button, alignment=Qt.AlignmentFlag.AlignCenter)
        buttons_vbox.addWidget(self.scan_all_files_button, alignment=Qt.AlignmentFlag.AlignCenter)
    ...
    def start_webcam(self) -> None:
        ...
        self.run_in_thread(renderer.render_start, capture, 0, None, True, "Webcam Feed", settings.MODEL)
